...
function renderProducts(){
 ...
 const container=byId('productsTable'); if(container) container.innerHTML=table(['<input type="checkbox" onchange="toggleAllProducts(this.checked)">','Product','Branch','Cost','Offline Price','Online Price','Offline Profit','Online Profit','Offline Margin','Online Margin','Updated','Actions'],rows);
